...
import os
import sys
from retainAI.constants import training_pipeline
...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.training_file_path: str = os.path.join(self.data_ingestion_dir, training_pipeline.TRAIN_FILE_NAME, training_pipeline.FILE_NAME)
        self.testing_file_path: str = os.path.join(self.data_ingestion_dir, training_pipeline.TEST_FILE_NAME, training_pipeline.FILE_NAME)
